...
"[project]/components/server-keep-alive.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ServerKeepAlive() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ServerKeepAlive.useEffect": ()=>{
            const pingServer = {
                "ServerKeepAlive.useEffect.pingServer": async ()=>{
                    try {
            ...
            }["ServerKeepAlive.useEffect.pingServer"];
            ...
            return ({
                "ServerKeepAlive.useEffect": ()=>clearInterval(interval)
            })["ServerKeepAlive.useEffect"];
        }
    }["ServerKeepAlive.useEffect"], []);
...
_s(ServerKeepAlive, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = ServerKeepAlive;
var _c;
__turbopack_context__.k.register(_c, "ServerKeepAlive");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
const firebaseConfig = {
    apiKey: ("TURBOPACK compile-time value", "AIzaSyCCr5l4o49ZINlNnY78FQgBfu37U7wu8Qg"),
    authDomain: ("TURBOPACK compile-time value", "psychometric-vocabulary-study.firebaseapp.com"),
    projectId: ("TURBOPACK compile-time value", "psychometric-vocabulary-study"),
    storageBucket: ("TURBOPACK compile-time value", "psychometric-vocabulary-study.firebasestorage.app"),
    messagingSenderId: ("TURBOPACK compile-time value", "34723043576"),
    appId: ("TURBOPACK compile-time value", "1:34723043576:web:a33c1d904d50c1e3ba430d")
};
const isConfigValid = Object.values(firebaseConfig).every((value)=>value && value !== "" && !value.includes("your-")) && ("TURBOPACK compile-time value", "object") !== "undefined" // Only initialize in browser
;
let app = null;
let auth = null;
if (isConfigValid) {
...
function AuthProvider({ children }) {
    ...
    const signInWithGoogle = async ()=>{
        ...
        const isEmbeddedBrowser = undefined;
    };
    const signOut = async ()=>{
...
_s1(AuthProvider, "g1BMRRM2FrHni62MKjzx5yCGHjw=", false, function() {
    return [
...
//# sourceMappingURL=_373f547a._.js.map